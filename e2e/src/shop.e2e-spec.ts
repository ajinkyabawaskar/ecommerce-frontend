...
describe('Protractor Demo App', function() {
  ...
  it('Should remove the product from cart', function() {
    var elem = element(by.xpath('//body/app-root[1]/app-navbar[1]/div[1]/mat-sidenav-container[1]/mat-sidenav-content[1]/app-cart[1]/div[1]/div[1]/div[2]/div[1]/mat-card[1]/div[1]/div[2]/mat-card-content[1]/mat-button[1]'));
    var until = protractor.ExpectedConditions;
    browser.wait(until.visibilityOf(elem), 5000).then(
      (ele2m) => {
        elem.click();
  ...
  it('Should click on log out ', function() {
    var elem = element(by.xpath('//body/app-root[1]/app-navbar[1]/div[1]/mat-toolbar[1]/button[2]'));
    var until = protractor.ExpectedConditions;
    browser.wait(until.visibilityOf(elem), 5000).then(
      (ele2m) => {
        elem.click();
